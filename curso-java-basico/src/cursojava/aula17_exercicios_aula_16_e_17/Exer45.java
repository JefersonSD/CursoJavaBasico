...
//			antes dos alunos usarem o programa.
		...
		String aluno1 = "Fernando", aluno2 = "Isabel", aluno3 = "Caio", aluno4 = "Jose", aluno5 = "Débora",
				nomeAluno = "";
		...
		do {
			...
			if(controleAluno >= 5) {
				System.err.println("Todos os alunos já fizeram prova");
				break;
			}
		...
		System.out.printf("Média das notas dos alunos: %.1f", media);
